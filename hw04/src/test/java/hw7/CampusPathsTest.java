...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	@Test
	public void testFindPath1() throws IOException {
		runTest("test2");
	}
	
	@Test
	public void testFindPath2() throws IOException {
		runTest("test3");
	}
	
	@Test
	public void testFindPath3() throws IOException {
		runTest("test4");
	}
	
	@Test
	public void testFindPath4() throws IOException {
		runTest("test5");
	}
	
	@Test
	public void testFindPath5() throws IOException {
		runTest("test6");
	}
